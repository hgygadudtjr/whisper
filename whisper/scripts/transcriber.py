...
def talker():
    ...
    while not rospy.is_shutdown():
        if microphone_active:  # microphone_active가 True일 때만 마이크로폰 입력을 받음
            ...
            with open("/home/kim/catkin_ws/src/whisper/scripts/microphone.wav", "wb") as f:
                f.write(audio.get_wav_data())

            result_text, detected_language = transcribe("/home/kim/catkin_ws/src/whisper/scripts/microphone.wav")
            microphone_counter = 0
            # 5초동안 result_text를 publish
...
if __name__ == '__main__':
    rospy.init_node('microphone_active', anonymous=True)
    try:
        talker()
